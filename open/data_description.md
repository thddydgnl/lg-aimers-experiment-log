...
> 이 문서는 공식 배포 데이터의 플랫폼 중립 스키마 설명이다. 현재 Windows PC의 경로·Python·재현 명령은 [`../LOCAL_ENVIRONMENT.md`](../LOCAL_ENVIRONMENT.md)를 따른다. 2026-08-17에 공식 `236743_v2/open.zip`을 다시 내려받아 아래 6개 파일이 로컬 파일과 SHA-256 기준으로 모두 일치함을 확인했다.
